...
As one would expect, the simulation data does not always line up with the observational data; instead, there are a number of known tensions between the two. One such tension is the size-mass relation of dwarf galaxies (\cite{salesBaryonicSolutionsChallenges2022}). Observational data of dwarf galaxies near the Milky Way suggests that the 
